...
public class JoinOrderRepository<T1, T2, T3, T4, T5, T6> : JoinRepository<T1, T2, T3, T4, T5, T6>, IJoinOrderRepository<T1, T2, T3, T4, T5, T6>
{
    public JoinOrderRepository(ILambdaRepository<JoinCondition<T1, T2, T3, T4, T5, T6>> source) : base(source)
    {
    }
...
public class JoinRepository<T1, T2, T3, T4, T5, T6> : IJoinRepository<T1, T2, T3, T4, T5, T6>
{
    public ILambdaRepository<JoinCondition<T1, T2, T3, T4, T5, T6>> Source { get; }

    public JoinRepository(ILambdaRepository<JoinCondition<T1, T2, T3, T4, T5, T6>> source)
    {
        Source = source;
    }
    ...
    private MethodCallExpression GetMaxOrMinOrSumOrAverageMethodCallExpression<TResult>(
        Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, TResult>> selector,
        MethodInfo methodInfo
    )
    {
        methodInfo = methodInfo.MakeGenericMethod(typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(TResult));
    ...
    public IJoinGroupRepository<T1, T2, T3, T4, T5, T6, TKey> GroupBy<TKey>(Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, TKey>> selector)
    {
        ...
        var result = new JoinGroupRepository<T1, T2, T3, T4, T5, T6, TKey>(r);
        return result;
    }
    ...
    public IJoinRepository<T1, T2, T3, T4, T5, T6> WhereIf(bool condition, Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, bool>> predicate)
    {
        if (condition)
        {
    ...
    public IJoinRepository<T1, T2, T3, T4, T5, T6, T7> LeftJoin<T7>(ILambdaRepository<T7> second, Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6, T7>, bool>> on)
    {
        var methodInfo = JoinRepository7MethodsCache.LeftJoin.MakeGenericMethod(typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7));
        return InternalJoin(second, on, methodInfo);
    }

    public IJoinRepository<T1, T2, T3, T4, T5, T6, T7> RightJoin<T7>(ILambdaRepository<T7> second, Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6, T7>, bool>> on)
    {
        var methodInfo = JoinRepository7MethodsCache.RightJoin.MakeGenericMethod(typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7));
        return InternalJoin(second, on, methodInfo);
    }

    public IJoinRepository<T1, T2, T3, T4, T5, T6, T7> InnerJoin<T7>(ILambdaRepository<T7> second, Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6, T7>, bool>> on)
    {
        var methodInfo = JoinRepository7MethodsCache.InnerJoin.MakeGenericMethod(typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7));
        return InternalJoin(second, on, methodInfo);
    }

    public ILambdaRepository<TResult> Select<TResult>(Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, TResult>> selector)
    {
        if (Source == null) throw new ArgumentNullException(nameof(Source));
    ...
    private MethodCallExpression GetCountMethodCallExpression(Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, bool>> predicate)
    {
        if (Source == null) throw new ArgumentNullException(nameof(Source));
    ...
    public int Count(Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, bool>> predicate)
    {
    ...
    public async Task<int> CountAsync(Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, bool>> predicate)
    {
        var callExpr = GetCountMethodCallExpression(predicate);
    ...
    protected IJoinOrderRepository<T1, T2, T3, T4, T5, T6> InternalOrderBy<TKey>(
        Expression<Func<JoinCondition<T1, T2, T3, T4, T5, T6>, TKey>> keySelector,
        MethodInfo methodInfo
    )
    {
        if (Source == null) throw new ArgumentNullException(nameof(Source));
        ...
        var r = Source.Provider.CreateQuery<ILambdaRepository<JoinCondition<T1, T2, T3, T4, T5, T6>>>(callExpr);
        var result = new JoinOrderRepository<T1, T2, T3, T4, T5, T6>(r);
        return result;
    }

    protected IJoinRepository<T1, T2, T3, T4, T5, T6, T7> InternalJoin<T7>(
        ILambdaRepository<T7> joinTable,
...
public class JoinGroupRepository<T1, T2, T3, T4, T5, T6, TKey> : IJoinGroupRepository<T1, T2, T3, T4, T5, T6, TKey>
{
    public ILambdaRepository<JoinCondition<T1, T2, T3, T4, T5, T6>> Source { get; }

    public JoinGroupRepository(ILambdaRepository<JoinCondition<T1, T2, T3, T4, T5, T6>> source)
    {
        Source = source;
    }
    public ILambdaRepository<TResult> Select<TResult>(Expression<Func<IGrouping<TKey, JoinCondition<T1, T2, T3, T4, T5, T6>>, TResult>> selector)
    {
        if (Source == null) throw new ArgumentNullException(nameof(Source));
