...
namespace SummerBoot.Test.Sqlite
{
    ...
    public class RepositoryTest
    {
        ...
        //{
        //    InitSqliteDatabase("Data Source=./TestJoinEntityWithStringNullCallMethod.db");
        ...
        //{
        //    InitSqliteDatabase("Data Source=./TestJoinEntityWithNullableProperty.db");
        ...
        {
            InitSqliteDatabase("Data Source=./TestWhereConditionContainDateTimeMethod.db");
        ...
        {
            InitSqliteDatabase("Data Source=./TestWhereConditionHaveNullableValue.db");
