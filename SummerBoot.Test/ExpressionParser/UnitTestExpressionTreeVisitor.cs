...
namespace ExpressionParser.Test
{
    ...
    public class UnitTestExpressionTreeVisitor
    {
        ...
        public async Task TestCount()
        {
            ...
            //Assert.Equal("sb", r1MiddleResult.Parameters[0].Value);
        }
        ...
        public void TestNullable2()
        {
            ...
            //Assert.Equal("hzp", r1MiddleResult.Parameters[1].Value);
        }
        [Fact]
        ...
        public void TestWhere2()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where((([p0].[HaveChildren] = 1) and([p0].[Name] = @y0)) and([p0].[Age] = 15))", r1MiddleResult.Sql);
            Assert.Equal(1, r1MiddleResult.Parameters.GetParamInfos.Count);
        ...
        public void TestWhere3()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where((([p0].[HaveChildren] = 0) and([p0].[Name] = @y0)) and([p0].[Age] = 15))", r1MiddleResult.Sql);
            Assert.Equal(1, r1MiddleResult.Parameters.GetParamInfos.Count);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        }
        ...
        public void TestWhere4()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where((([p0].[Name] = @y0) and([p0].[HaveChildren] = 0)) and([p0].[Age] = 15))", r1MiddleResult.Sql);
            Assert.Equal(1, r1MiddleResult.Parameters.GetParamInfos.Count);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        }
        ...
        public void TestWhere6()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where(([p0].[HaveChildren] = 1) and([p0].[HaveChildren] = 1))", r1MiddleResult.Sql);
            Assert.Empty(r1MiddleResult.Parameters.GetParamInfos);
        }
        [Fact]
        ...
        public void TestWhere19()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where(trim([p0].[Name]) = @y0)", r1MiddleResult.Sql);
            Assert.Single(r1MiddleResult.Parameters.GetParamInfos);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        }
        ...
        public void TestWhere21()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where(ltrim([p0].[Name]) = @y0)", r1MiddleResult.Sql);
            Assert.Single(r1MiddleResult.Parameters.GetParamInfos);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        }
        ...
        public void TestWhere23()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where(rtrim([p0].[Name]) = @y0)", r1MiddleResult.Sql);
            Assert.Single(r1MiddleResult.Parameters.GetParamInfos);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        }
        ...
        public void TestWhere29()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where(lower([p0].[Name]) = @y0)", r1MiddleResult.Sql);
            Assert.Single(r1MiddleResult.Parameters.GetParamInfos);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        }
        [Fact]
        ...
        public void TestWhere31()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where(upper([p0].[Name]) = @y0)", r1MiddleResult.Sql);
            Assert.Single(r1MiddleResult.Parameters.GetParamInfos);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        }
        [Fact]
        ...
        public void TestWhere33()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] where [p0].[Name] in(@y0,@y1)", r1MiddleResult.Sql);
            Assert.Equal(2, r1MiddleResult.Parameters.GetParamInfos.Count);
            Assert.Equal("hzp", r1MiddleResult.Parameters.GetParamInfos["y0"].Value);
        ...
        public void TestWhere38()
        {
            ...
            Assert.Equal("select * from [TestWhereNewDatetime] as [p0] where([p0].[Time] = @y0)", r1MiddleResult.Sql);
            Assert.Equal(1, r1MiddleResult.Parameters.GetParamInfos.Count);
        ...
        public void TestOrderBy()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] order by [p0].[Age] asc", r1MiddleResult.Sql);
        ...
        public void TestOrderBy2()
        {
            ...
            Assert.Equal("select * from [Person] as [p0] order by [p0].[Age] desc", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        [Fact]
        public void TestOrderBy3()
        {
            ...
            Assert.Equal("select * from [Person] as [p0] order by [p0].[Age] asc, [p0].[Name] asc", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        ...
        public void TestOrderBy4()
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            Assert.Equal("select * from [Person] as [p0] order by [p0].[Age] asc, [p0].[Name] desc", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        ...
        public void TestOrderBy5()
        {
            ...
            Assert.Equal("select * from [Person] as [p0] order by [p0].[Age] desc, [p0].[Name] desc", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        ...
        public void TestOrderBy6()
        {
            ...
            Assert.Equal("select * from [Person] as [p0] order by [p0].[Age] desc, [p0].[Name] asc", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        ...
        public void TestGroupBy()
        {
            ...
            Assert.Equal("select * from [Person] as [p0] group by [p0].[Name]", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        ...
        public void TestGroupBy2()
        {
            ...
            Assert.Equal("select * from [Person] as [p0] group by [p0].[Name], [p0].[Age]", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        [Fact]
        ...
        public void TestBool(bool bv)
        {
            ...
            var r1MiddleResult = personRepository.GetParsingResult();
            var t = bv ? 1 : 0;
            Assert.Equal($"select * from [Person] as [p0] where(1 = {t})", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        ...
        public void TestBool2()
        {
            ...
            Assert.Equal($"select * from [Person] as [p0] where(1 = 1)", r1MiddleResult.Sql);
            Assert.Equal(0, r1MiddleResult.Parameters.GetParamInfos.Count);
        }
        ...
        public void TestMysqlFirstOrDefault()
        {
            ...
            //Assert.Equal("@y0", r1MiddleResult.Parameters[0].ParameterName);
            //Assert.Equal(0, r1MiddleResult.Parameters[0].Value);
        ...
        public void TestSkipAndTake()
        {
            ...
            //Assert.Equal("@y1", r1MiddleResult.Parameters[1].ParameterName);
            //Assert.Equal(2, r1MiddleResult.Parameters[1].Value);
        }
        ...
        public void TestSkipAndTake3()
        {
            ...
            //Assert.Equal(2, r1MiddleResult.Parameters[2].Value);
        }
        ...
        public void TestMysqlSkipAndTake2()
        {
            ...
            //Assert.Equal("@y1", r1MiddleResult.Parameters[1].ParameterName);
            //Assert.Equal(5, r1MiddleResult.Parameters[1].Value);
        }
        ...
        public void TestMysqlSkipAndTake3()
        {
            ...
            //Assert.Equal("@y0", r1MiddleResult.Parameters[0].ParameterName);
            //Assert.Equal(5, r1MiddleResult.Parameters[0].Value);

            //Assert.Equal("@y1", r1MiddleResult.Parameters[1].ParameterName);
            //Assert.Equal(int.MaxValue, r1MiddleResult.Parameters[1].Value);
        }
