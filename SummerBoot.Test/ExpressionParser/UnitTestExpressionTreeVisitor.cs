...
namespace ExpressionParser.Test
{
    ...
    public class UnitTestExpressionTreeVisitor
    {
        ...
        public void TestSelect3()
        {
            ...
            Assert.Equal("SELECT [p0].[Name], '福建' As [Address] FROM [Person] [p0]", r3MiddleResult.Sql);
        ...
        public void TestCombineSelectAndWhere2()
        {
            ...
            Assert.Equal("SELECT [p0].[Age], '福建' As [Address] FROM [Person] [p0] WHERE  ([p0].[Name] = @y0 )", r1MiddleResult.Sql);
            Assert.Single(r1MiddleResult.SqlParameters);
        ...
        {
            var hrRepository = new HrRepository();
            var persion = new Hr() { Age = 5, HaveChildren = false, Name = "张三", EmployeNo = "666", CreateOn = DateTime.Now };
